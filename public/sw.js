const CACHE='idm-v6';
const APP=['/','/styles.css','/dashboard.css','/phase2.css','/region.css','/history.css','/app.js','/dashboard.js','/phase2.js','/region.js','/history.js','/health.js','/manifest.webmanifest'];
