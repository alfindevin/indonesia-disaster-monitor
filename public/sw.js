const CACHE='idm-v13';
const APP=['/','/styles.css','/dashboard.css','/phase2.css','/region.css','/history.css','/phase1.css','/phase3.css','/phase4.css','/map-markers.css','/app.js','/dashboard.js','/phase2.js','/region.js','/phase1.js','/phase1-bridge.js','/phase3.js','/phase4.js','/sidebar-toggle.js','/health.js','/history.js','/manifest.webmanifest'];
